        ...
        <center>
            <form enctype="multipart/form-data" style="margin-top: 50px;align-items: left;">
                ...
                <div class="col-md-6 row" style="margin-top: 20px;">
                    ...
                    <div class="col-md-8">
                        <textarea type="text" class="form-control" name="keperluan" rows="4" style="color:black;" cols="50" required="true" readonly="true" >{{ $peminjamanRuangan->keperluan }}</textarea>
                    </div>
                </div>   
                <div class="col-md-6 row" style="margin-top: 20px;">
                    <div class="col-md-4 left">
