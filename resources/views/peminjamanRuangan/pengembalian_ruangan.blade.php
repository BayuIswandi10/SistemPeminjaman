                ...
                <table class="col-lg-12 table-strip table" width="100%" id="example">
                    <thead>
                        <tr>
                            ...
                            <th><center>Foto Sebelum</center></th>
                            <th><center>Foto Sesudah</center></th>
                    ...
                    <tbody>
                        @php
                            $count = 0;
                        @endphp
                        @foreach($peminjamanRuangan as $row)
                            @php
                                $count++;
                            @endphp
                            ...
                            <tr>
                                ...
                                <td><center>{{ $row->ruangan->nama_ruangan }}</center></td>
                                ...
                                <td><center>
                                    @if($row->foto_sebelum == '')
                                        -
                                    @else
                                        <img src="{{ asset($row->foto_sebelum) }}" alt="" style="width: 80%" onclick="zoom('img{{ $count }}')" id="img{{ $count }}">
                                    @endif
                                </center></td>
                                <td><center>
                                    @if($row->foto_setelah == '')
