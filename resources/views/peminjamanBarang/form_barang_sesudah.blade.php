...
<div class="super_container">
    ...
    <div class="row" style="margin-top: 100px; width: 100%; height:100%; background-color: #0059ab; margin-left: 0px; margin-right: 0px;">
        ...
        <center>
            <form enctype="multipart/form-data" action="{{ route('pesanan_barang.updateBarangSesudah', $peminjamanBarang->peminjaman_barang_id) }}" method="post" style="margin-top: 50px;align-items: left;">
                @method('PUT')
                @csrf
                <br>
                ...
                <div class="col-md-6 row" style="margin-top: 20px;">
                    ...
                    <div class="col-md-8">
                        <input type="time" class="form-control" name="waktu_kembali" style="color:black;" value="{{ $peminjamanBarang->waktu_kembali }}" required="true" readonly="true" />
                    </div>
                </div>
                <div class="col-md-6 row" style="margin-top: 20px;">
                    <div class="col-md-4 left">
                    ...
                    <div class="col-md-8">
                        <textarea type="text" class="form-control" name="keperluan" rows="4" cols="50" style="color:black;" required="true" readonly="true" >{{ $peminjamanBarang->keperluan }}</textarea>
                    </div>
                </div>
                <div class="col-md-6 row" style="margin-top: 20px;">
                    <div class="col-md-4 left">
