...
<div class="super_container">
    ...
    <div class="row" style="margin-top: 100px; width: 100%; height:100%; background-color: #0059ab; margin-left: 0px; margin-right: 0px;">
        <center><h1 style="margin-top: 50px; color: white">FORM PEMINJAMAN BARANG SEBELUM </h1></center>
        <center>
            <form enctype="multipart/form-data" action="{{ route('pesanan_barang.updateBarangSebelum', $peminjamanBarang->peminjaman_barang_id) }}" method="post" style="margin-top: 50px;align-items: left;">
                @method('PUT')
                @csrf
                <br>
                ...
                <div class="col-md-6 row" style="margin-top: 20px;">
                    ...
                    <div class="col-md-8">
                        <input id="datepciker" type="date" style="color:black;" value="{{ $peminjamanBarang->tanggal_pinjam }}" min="{{ date('Y-m-d') }}" style="color: black;" name="tanggal" class="form-control" required="true" readonly="true">
                    </div>
                </div>                
                <div class="col-md-6 row" style="margin-top: 20px;">
                    <div class="col-md-4 left">
                ...
                <div class="col-md-6 row" style="margin-top: 20px;">
                    ...
                    <div class="col-md-8">
                        <input type="time" class="form-control" style="color:black;" name="waktu_kembali" value="{{ $peminjamanBarang->waktu_kembali }}" required="true" readonly="true" />
                    </div>
                </div>
                <div class="col-md-6 row" style="margin-top: 20px;">
                    <div class="col-md-4 left">
                    ...
                    <div class="col-md-8">
                        <textarea type="text" class="form-control" style="color:black;" name="keperluan" rows="4" cols="50" required="true" readonly="true" >{{ $peminjamanBarang->keperluan }}</textarea>
                    </div>
                </div>
                <div class="col-md-6 row" style="margin-top: 20px;">
                    <div class="col-md-4 left">
